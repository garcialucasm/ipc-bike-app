            ...
            {!closedAlert && (
              ...
              >
                <div className="mb-3 flex items-center">
                  ...
                  <button
                    type="button"
                    className="-mx-1.5 -my-1.5 ms-auto inline-flex h-6 w-6 items-center justify-center rounded-2xl bg-blue-50 p-1 text-blue-900 hover:bg-blue-200 focus:ring-2 focus:ring-blue-400"
