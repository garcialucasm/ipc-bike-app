  ...
  return (
    <>
      <nav className="flex w-full items-center justify-between flex-wrap py-2">
        ...
        >
          <div className="absolute bg-white border border-gray-200 rounded-lg text-sm text-left shadow-lg">
            <Link href="" className="text-gray-500">
              <div className="block py-2 px-8 hover:bg-gray-100 hover:rounded-lg hover:text-blue-700">
            ...
            <Link href="" className="text-gray-500">
              <div className="block py-2 px-8 hover:bg-gray-200 hover:rounded-lg hover:text-blue-700">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="20"
            ...
            >
              <div className="block py-2 px-8 bg-gray-100 rounded-lg border-gray-200 border-t hover:bg-gray-200 hover:rounded-lg hover:text-blue-700">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="20"
