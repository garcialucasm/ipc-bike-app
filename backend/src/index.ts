...
const userRepository: IUserRepository = new UserRepository(client)
const bikeRepository: IBikeRepository = new BikeRepository(client)
const bookingRepository: IBookingRepository = new BookingRepository(client)
